...
keep if lwage !=.;
keep birthpl ch71 en71 nin wsppc lwage yeduc dum p504thn;
...
log using log/table6A2, replace;

quietly anova lwage yeduc p504thn birthpl ch71, cont(ch71 yeduc);
display "coeff X= " _b[yeduc];
display "se X= " _se[yeduc];

quietly anova lwage yeduc p504thn birthpl ch71 en71, cont(ch71 yeduc en71);
display "coeff X= " _b[yeduc];
display "se X= " _se[yeduc];

quietly anova lwage yeduc p504thn birthpl ch71 en71 wsppc, cont(ch71 yeduc en71 wsppc);
display "coeff X= " _b[yeduc];
display "se X= " _se[yeduc];

quietly reg lwage yeduc year1-year23 ROB1-ROB290 cYOB1-cYOB23 (year1-year23 ROB1-ROB290 cYOB1-cYOB23
ndum1 ndum2 ndum3 ndum4 ndum5 ndum6 ndum7 ndum8 ndum9 ndum10 ndum11 ndum12);
display "coeff X= " _b[yeduc];
display "se X= " _se[yeduc];

quietly reg lwage yeduc year1-year23 ROB1-ROB290 cYOB1-cYOB23 eYOB1-eYOB23 (year1-year23 ROB1-ROB290 cYOB1-cYOB23
ndum1 ndum2 ndum3 ndum4 ndum5 ndum6 ndum7 ndum8 ndum9 ndum10 ndum11 ndum12 eYOB1-eYOB23);
display "coeff X= " _b[yeduc];
display "se X= " _se[yeduc];

quietly reg lwage yeduc year1-year23 ROB1-ROB290 cYOB1-cYOB23 eYOB1-eYOB23 wYOB1-wYOB23 (year1-year23 ROB1-ROB290 cYOB1-cYOB23
